...
const Footer = () => {
  ...
  return (
    <div className="flex justify-between text-white py-7 max-md:flex-col max-md:gap-4">
      <Link to={"/"}>
      ...
      <div className="flex gap-2 max-md:mt-1">
        ...
        <img src="/assets/threads.png" className="h-8" />
      </div>
    </div>
  );
};
